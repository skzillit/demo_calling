...
public class PeerProto implements AbsWebSocketTransport.Listener {

    private static final String TAG = "Peer";

    public PeerProto(@NonNull AbsWebSocketTransport mTransport, @NonNull Listener mListener, @NonNull Handler mTimerCheckHandler) {
        this.mTransport = mTransport;
        this.mListener = mListener;
        this.mTimerCheckHandler = mTimerCheckHandler;
    }
...
//            mTimerCheckHandler.po//postDelayed(this, timeoutDelayMillis);
        }
...
//            mTimerCheckHandler.removeCallbacks(this);
    ...
    public PeerProto(@NonNull AbsWebSocketTransport transport, @NonNull Listener listener) {
        mTransport = transport;
        mListener = listener;
        mTimerCheckHandler = new Handler() {
            @Override
